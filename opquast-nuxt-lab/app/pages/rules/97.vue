        ...
        <div class="p-6">
          ...
          >
            <p class="text-sm text-zinc-400">
              Exemple : champs signalés pour l’auto-complétion via <code class="text-zinc-300">autocomplete</code>.
            </p>

            <form class="rounded-xl border border-zinc-800 bg-zinc-950 p-5 space-y-4">
              <div class="grid gap-4 sm:grid-cols-2">
                <div>
                  <label for="givenName" class="block text-sm font-medium text-zinc-200">Prénom</label>
                  <input
                    id="givenName"
                    type="text"
                ...
                <div>
                  <label for="familyName" class="block text-sm font-medium text-zinc-200">Nom</label>
                  <input
                    id="familyName"
                    type="text"
            ...
            <p class="text-xs text-zinc-500">
              Le “signalement” est dans le code : les navigateurs et technologies d’assistance s’appuient sur <code class="text-zinc-300">autocomplete</code>.
            </p>
          </div>
...
&lt;input id="givenName" autocomplete="given-name" /&gt;

&lt;label for="familyName"&gt;Nom&lt;/label&gt;
&lt;input id="familyName" autocomplete="family-name" /&gt;
