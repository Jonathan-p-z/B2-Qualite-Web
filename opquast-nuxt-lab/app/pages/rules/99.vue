				...
				<div class="p-6">
					...
					>
						<p class="text-sm text-zinc-400">
							Exemple : une page d’accueil qui explique clairement le contenu du site et les actions possibles dès le premier écran.
						</p>
						...
						>
							<header class="space-y-2">
								<p class="text-xs text-zinc-500">Bienvenue sur</p>
								<h3 id="home-title" class="text-lg font-semibold text-zinc-100">
									MonService — comparer, choisir et suivre vos démarches
								</h3>
								<p class="text-sm text-zinc-300">
									Ici, vous pouvez comparer des offres, simuler un prix, et accéder à vos documents.
								</p>
							</header>

							<div class="grid gap-3 sm:grid-cols-3" aria-label="Services principaux">
								<article class="rounded-lg border border-zinc-800 bg-zinc-900/20 p-4">
									<h4 class="text-sm font-medium text-zinc-100">Comparer</h4>
									<p class="mt-1 text-sm text-zinc-400">
										Trouver l’offre adaptée à votre besoin.
									</p>
								</article>

								<article class="rounded-lg border border-zinc-800 bg-zinc-900/20 p-4">
									<h4 class="text-sm font-medium text-zinc-100">Simuler</h4>
									<p class="mt-1 text-sm text-zinc-400">
										Estimer un tarif en 2 minutes.
									</p>
								</article>

								<article class="rounded-lg border border-zinc-800 bg-zinc-900/20 p-4">
									<h4 class="text-sm font-medium text-zinc-100">Suivre</h4>
									<p class="mt-1 text-sm text-zinc-400">
										Accéder à vos demandes et documents.
									</p>
								</article>
							</div>

							<div class="rounded-lg border border-zinc-800 bg-zinc-900/10 p-4">
								<h4 class="text-sm font-medium text-zinc-100" id="who-for">Pour qui ?</h4>
								<p class="mt-1 text-sm text-zinc-400" aria-describedby="who-for">
									Particuliers et petites entreprises.
								</p>
							</div>

							<nav class="flex flex-wrap gap-2" aria-label="Accès rapides">
								<a
									href="#"
							...
							<p class="text-xs text-zinc-500">
								Astuce : le titre, le résumé et les accès rapides rendent la « promesse » du site explicite (contenus + services).
							</p>
						</section>
					</div>
...
&lt;header&gt;
	&lt;h1&gt;MonService — comparer, choisir et suivre vos démarches&lt;/h1&gt;
	&lt;p&gt;Ici, vous pouvez comparer des offres, simuler un prix, et accéder à vos documents.&lt;/p&gt;
&lt;/header&gt;

&lt;section aria-label="Services principaux"&gt;
	&lt;h2&gt;Services principaux&lt;/h2&gt;
	&lt;ul&gt;
		&lt;li&gt;&lt;strong&gt;Comparer&lt;/strong&gt; : trouver l’offre adaptée.&lt;/li&gt;
		&lt;li&gt;&lt;strong&gt;Simuler&lt;/strong&gt; : estimer un tarif.&lt;/li&gt;
		&lt;li&gt;&lt;strong&gt;Suivre&lt;/strong&gt; : accéder à vos demandes.&lt;/li&gt;
	&lt;/ul&gt;
&lt;/section&gt;

&lt;nav aria-label="Accès rapides"&gt;
	&lt;a href="/simulation"&gt;Démarrer une simulation&lt;/a&gt;
	&lt;a href="/offres"&gt;Découvrir les offres&lt;/a&gt;
	&lt;a href="/compte"&gt;Accéder à mon espace&lt;/a&gt;
&lt;/nav&gt;
</code></pre>
					</div>
				</div>
